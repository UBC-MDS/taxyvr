...
The goal of taxyvr is to provide an easily way to access the Vancouver housing assessment data. This is semi-tidied data obtained from the City of Vancouver's Open Data Portal.
